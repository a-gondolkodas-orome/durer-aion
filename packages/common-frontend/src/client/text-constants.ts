export const dictionary = {
  disclaimer: {
    ...
    interfaceDescriptionBHTML:
      "A felület mobilon és gépen is kitölthető. Kérünk bennetek, hogy {maximumOneDevice} töltsétek ki az online fordulót, továbbá {dontRefresh} a verseny során.",
    interfaceMaxDevice: "legfeljebb 1 eszközről",
    interfaceDontRefresh: "ne frissítsétek le az oldalt",
    interfaceDescripSmall: 
      "(Ha mégis frissítitek az oldalt, akkor a verseny újraindul (de az eddigi eredményeitek megmaradnak). Ekkor - minél gyorsabban - menjetek vissza ahhoz a feladathoz, ahol jártatok. " +
      "Figyeljetek arra, hogy bár az időzítő újraindul a frissítés után, de így is csak az időben beérkezett válaszokat fogjuk figyelembe venni.)",
