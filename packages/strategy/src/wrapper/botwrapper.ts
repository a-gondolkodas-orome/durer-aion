...
const { Bot } = require('boardgame.io/ai');
...
export function botWrapper<T_SpecificGameState, T_Move>(botstrategy: BotStrategy<T_SpecificGameState, T_Move>): new (opts: BotOpts) => typeof Bot {
